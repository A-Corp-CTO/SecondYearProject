...
def save_model(model,token,tags):
    filename = 'Models/baseline_model.sav'
    pickle.dump(model,open(filename, 'wb'))
    token_name = 'Data/token_to_id.sav'
    pickle.dump(token,open(token_name,'wb'))
    tags_name = 'Data/tags_to_id.sav'
    pickle.dump(tags,open(tags_name,'wb'))
